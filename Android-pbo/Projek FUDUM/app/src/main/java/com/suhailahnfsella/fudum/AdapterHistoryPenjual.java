...
public class AdapterHistoryPenjual extends RecyclerView.Adapter<AdapterHistoryPenjual.ViewHolder>{
    ...
    public AdapterHistoryPenjual(List<DataHistory> mar) {
        this.mar = mar;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.item_history_pesan,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int i) {
        ...
        if (mar.get(i).getIdtoko() == loginModel.getId()){
            ...
            holder.btnProses.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), ProsesOrder.class);
