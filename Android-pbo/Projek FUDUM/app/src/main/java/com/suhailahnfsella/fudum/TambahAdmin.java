        ...
        btnDaftar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!etNamaLkp.getText().toString().matches("^[a-z,A-Z\\s]+$")){
                    ...
                    Toast.makeText(TambahAdmin.this, "Email harus diisi!", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(TambahAdmin.this, "Masukkan Kode OTP!", Toast.LENGTH_SHORT).show();
                } else
                {
        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(etTelp.getText().toString()) && etTelp.length() < 11) {
                    ...
                    Toast.makeText(TambahAdmin.this, "Masukkan Nomor dulu!", Toast.LENGTH_SHORT).show();
                } else {
...
//                            finish();
                            ...
                            Toast.makeText(TambahAdmin.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            Toast.makeText(TambahAdmin.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
                ...
                .addOnFailureListener(this, new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        if (e instanceof ApiException) {
                            ...
                            Toast.makeText(TambahAdmin.this, "Error found is : " + e, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getBoolean("success")) {
                                ...
                                Toast.makeText(TambahAdmin.this, "User verified with reCAPTCHA", Toast.LENGTH_SHORT).show();
                            } else {
    ...
    public void daftarUsers(DaftarModel daftarModel){
        Call<GetDaftar> getDaftarCall = ApiClient.getApi().daftarAdmin(daftarModel);
        getDaftarCall.enqueue(new Callback<GetDaftar>() {
            @Override
            public void onResponse(Call<GetDaftar> call, Response<GetDaftar> response) {
                if (response.isSuccessful()){
                    Intent intent = new Intent(TambahAdmin.this,AdminPage.class);
                    ...
                    etEmail = findViewById(R.id.etTelpLupaPw);
                    etTelp = findViewById(R.id.etTelp);
                    etUsernameBr.setError("Gunakan Nama Pengguna yang belum terdaftar sebelumnya!");
                    etEmail.setError("Gunakan Email yang belum terdaftar sebelumnya!");
                    etTelp.setError("Gunakan No Telp yang belum terdaftar sebelumnya!");
                }
            }
            ...
            public void onFailure(Call<GetDaftar> call, Throwable t) {
                ...
                Toast.makeText(TambahAdmin.this, message, Toast.LENGTH_LONG).show();
            }
        });
    }
}