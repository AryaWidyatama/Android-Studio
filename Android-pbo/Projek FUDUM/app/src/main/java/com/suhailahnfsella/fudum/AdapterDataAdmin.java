...
public class AdapterDataAdmin extends RecyclerView.Adapter<AdapterDataAdmin.MyViewHolder>{
    List<UserModel> mKategoriList;
    LoginModel loginModel;

    public AdapterDataAdmin(List <UserModel> KategoriList) {
    ...
    @Override
    public void onBindViewHolder (AdapterDataAdmin.MyViewHolder holder, final int position){
        ...
        if (mKategoriList.get(position).getLevel().matches("admin")) {
