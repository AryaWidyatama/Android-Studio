...
public class UbahStatusUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Ubah Status User");
    ...
    public void panggilRetrofit() {
        Call<GetUser> kontakCall = mApiInterface.getUser();
        kontakCall.enqueue(new Callback<GetUser>() {
            ...
            public void onResponse(Call<GetUser> call, Response<GetUser>
                ...
                mAdapter = new AdapterUbahStatusUser(ListMenu);
