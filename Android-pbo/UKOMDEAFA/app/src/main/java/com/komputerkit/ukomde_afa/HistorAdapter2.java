...
public class HistorAdapter2 extends RecyclerView.Adapter<HistorAdapter2.ViewHolder>{
    List<DataHistory> mKontakList;
    Context context;
    public HistorAdapter2(List<DataHistory> MenuList) {
    ...
    @Override
    public HistorAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HistorAdapter2.ViewHolder holder, final int position) {
        String ha = "ready";
