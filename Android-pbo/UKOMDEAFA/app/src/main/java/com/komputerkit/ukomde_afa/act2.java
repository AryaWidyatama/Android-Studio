 ...
 * Use the {@link act2#newInstance} factory method to
...
public class act2 extends Fragment {
     ...
     * @return A new instance of fragment act2.
     */
    // TODO: Rename and change types and number of parameters
    public static act2 newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Integer myDataFromActivity = activity.getMyData1();
...
//        TextView myAwesomeTextView = root.findViewById(R.id.act2tv);
    ...
    public void panggilRetrofit(){
        ...
        kontakCall.enqueue(new Callback<GetDataHistory>() {
            ...
            public void onResponse(Call<GetDataHistory> call, Response<GetDataHistory>
                ...
                mAdapter = new HistorAdapter2(KontakList);
