...
public class HistoryAdapter3  extends RecyclerView.Adapter<HistoryAdapter3.ViewHolder>{
    List<DataHistory> mKontakList;
    Context context;
    public HistoryAdapter3(List<DataHistory> MenuList) {
    ...
    @Override
    public HistoryAdapter3.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HistoryAdapter3.ViewHolder holder, final int position) {
        String ha = "selesai";
...
//        holder.tvkodebrg.setText(myDatalist.getKodeBarang());
                holder.cardView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(view.getContext(),HistoryUser.class);
