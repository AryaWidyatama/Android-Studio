 ...
 * Use the {@link act1#newInstance} factory method to
...
public class act1 extends Fragment {
    ...
    public act1() {
        // Required empty public constructor selamat datang di kegelapan sebuah project hehhh jadi yang mana hiks
    }
     ...
     * @return A new instance of fragment act1.
     */
    // TODO: Rename and change types and number of parameters
    public static act1 newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_act1, null);
        Integer myDataFromActivity = activity.getMyData();

    //    TextView myAwesomeTextView = root.findViewById(R.id.ha);
       // myAwesomeTextView.setText(myDataFromActivity);
    ...
    public void run(){
        ma=this;
        HIstoryFragment activity = (HIstoryFragment) getActivity();
        Integer myData = activity.getMyData();
