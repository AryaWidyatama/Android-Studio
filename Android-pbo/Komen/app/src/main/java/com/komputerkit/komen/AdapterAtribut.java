...
public class AdapterAtribut extends RecyclerView.Adapter<AdapterAtribut.MyViewHolder>{
    List<Barang> mKategoriList;

    public AdapterAtribut(List <Barang> KategoriList) {
    ...
    @Override
    public void onBindViewHolder (AdapterAtribut.MyViewHolder holder, final int position){
