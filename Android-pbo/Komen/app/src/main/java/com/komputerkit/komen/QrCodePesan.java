...
public class QrCodePesan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qr_code_pesan);
    ...
    public void kembali(View view) {
        Intent intent = new Intent(QrCodePesan.this,OpsiPesanan.class);
