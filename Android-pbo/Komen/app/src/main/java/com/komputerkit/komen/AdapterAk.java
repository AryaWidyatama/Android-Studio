...
public class AdapterAk extends RecyclerView.Adapter<AdapterAk.MyViewHolder>{

    List<JasaModel> mKategoriList;

    public AdapterAk(List <JasaModel> KategoriList) {
        this.mKategoriList = KategoriList;
    }

    @Override
    public AdapterAk.MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
    ...
    @Override
    public void onBindViewHolder (AdapterAk.MyViewHolder holder, final int position){
