...
public class AdapterOTKP extends RecyclerView.Adapter<AdapterOTKP.MyViewHolder>{

    List<JasaModel> mKategoriList;

    public AdapterOTKP(List <JasaModel> KategoriList) {
        this.mKategoriList = KategoriList;
    }

    @Override
    public AdapterOTKP.MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
    ...
    @Override
    public void onBindViewHolder (AdapterOTKP.MyViewHolder holder, final int position){
