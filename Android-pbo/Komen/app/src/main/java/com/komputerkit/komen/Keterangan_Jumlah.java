...
//                }
                ...
                call.enqueue(new Callback<GetPesananModel>() {
                    ...
                    public void onResponse(Call<GetPesananModel> call, Response<GetPesananModel> response) {
                        ...
                        btnoke.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent intent1 = new Intent(Keterangan_Jumlah.this, ArCode.class);
    ...
    public void Beli(View view) {
        ...
        progressBar = new ProgressDialog(Keterangan_Jumlah.this);
        progressBar.show();
      ...
      if(TextUtils.isEmpty(tv3.getText().toString())){
          ...
          h2.setError("Harus Isi Deksripsi");
          progressBar.dismiss();
          ...
          btnoke.setOnClickListener(new View.OnClickListener() {
              @Override
              public void onClick(View view) {
                  Intent intent1 = new Intent(Keterangan_Jumlah.this, VerifikasiAkunAct.class);
