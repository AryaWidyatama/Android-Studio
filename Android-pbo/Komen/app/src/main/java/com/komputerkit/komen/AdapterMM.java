...
public class AdapterMM extends RecyclerView.Adapter<AdapterMM.MyViewHolder>{

    List<JasaModel> mKategoriList;

    public AdapterMM(List <JasaModel> KategoriList) {
        this.mKategoriList = KategoriList;
    }

    @Override
    public AdapterMM.MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
    ...
    @Override
    public void onBindViewHolder (AdapterMM.MyViewHolder holder, final int position){
