...
public class AdapterMinuman extends RecyclerView.Adapter<AdapterMinuman.MyViewHolder>{
    ...
    public AdapterMinuman(List <Barang> KategoriList) {
        this.mKategoriList = KategoriList;
    }

    @Override
    public AdapterMinuman.MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
    ...
    @Override
    public void onBindViewHolder (AdapterMinuman.MyViewHolder holder, final int position){
