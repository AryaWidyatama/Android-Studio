...
public class RPLAct extends AppCompatActivity {
    TextView tvJudul;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rplact);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
              if (s.length() > 0){
                  Call<GetJasaModel> kontakCall = mApiInterface.rpl(s);
                  kontakCall.enqueue(new Callback<GetJasaModel>() {
                      ...
                      public void onResponse(Call<GetJasaModel> call, Response<GetJasaModel>
                          ...
                          mAdapter = new AdapterRPL(ListMenu);
    ...
    public void panggilRetrofit() {
        Call<GetJasaModel> kontakCall = mApiInterface.showrpl();
        kontakCall.enqueue(new Callback<GetJasaModel>() {
            @Override
            public void onResponse(Call<GetJasaModel> call, Response<GetJasaModel>
                    response) {
