...
public class DaftarLanjutan extends AppCompatActivity {
   private FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_lanjutan);
...
//                    getLogin = (LoginEmail) intent.getSerializableExtra("data");
    ...
    public void countdown(){
        ...
        haha  =   new CountDownTimer(duration,1000){
            ...
            public void onFinish(){
                dialog=new Dialog(DaftarLanjutan.this);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(DaftarLanjutan.this, "Berhasil", Toast.LENGTH_SHORT).show();
                            Intent intent = getIntent();
                    ...
                    daftarUsers(daftarModel);
                            ...
                            Toast.makeText(DaftarLanjutan.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            Toast.makeText(DaftarLanjutan.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
    ...
    public void daftarUsers(SiswaModel daftarModel){
        Call<GetSiswa> getDaftarCall = ApiClient.getApi().daftarUser(daftarModel);
        getDaftarCall.enqueue(new Callback<GetSiswa>() {
            @Override
            public void onResponse(Call<GetSiswa> call, Response<GetSiswa> response) {
                if (response.isSuccessful()){
                    Intent intent = new Intent(DaftarLanjutan.this,Login.class);
            ...
            public void onFailure(Call<GetSiswa> call, Throwable t) {
                ...
                Toast.makeText(DaftarLanjutan.this, message, Toast.LENGTH_LONG).show();
            }
        });
    }
}