...
public class AKAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_akact);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
              if (s.length() > 0){
                  Call<GetJasaModel> kontakCall = mApiInterface.ak(s);
                  kontakCall.enqueue(new Callback<GetJasaModel>() {
                      ...
                      public void onResponse(Call<GetJasaModel> call, Response<GetJasaModel>
                          ...
                          Log.d("Retrofit Get", "Jumlah data Kontak: " +
                                  ...
                                  mAdapter = new AdapterAk(ListMenu);
    ...
    public void panggilRetrofit() {
        Call<GetJasaModel> kontakCall = mApiInterface.showak1();
        kontakCall.enqueue(new Callback<GetJasaModel>() {
            @Override
            public void onResponse(Call<GetJasaModel> call, Response<GetJasaModel>
                    response) {
