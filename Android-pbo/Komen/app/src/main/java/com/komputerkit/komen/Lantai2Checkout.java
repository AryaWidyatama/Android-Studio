...
public class Lantai2Checkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lantai2_checkout);
...
//            String selectedImage = intent.getStringExtra("gambar");
            ...
            Glide.with(Lantai2Checkout.this)
            ...
            if (json != "") {
                ...
                call.enqueue(new Callback<GetPesananModel>() {
                    ...
                    public void onResponse(Call<GetPesananModel> call, Response<GetPesananModel> response) {
                        dialog=new Dialog(Lantai2Checkout.this);
                        ...
                        btnoke.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent intent1 = new Intent(Lantai2Checkout.this, ArCode.class);
    ...
    public void Beli(View view) {
        ...
        progressBar = new ProgressDialog(Lantai2Checkout.this);
        progressBar.show();
        ...
        if(TextUtils.isEmpty(tv3.getText().toString())){
            ...
            btnoke.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent1 = new Intent(Lantai2Checkout.this, VerifikasiAkunAct.class);
