...
public class AdapterMakanan extends RecyclerView.Adapter<AdapterMakanan.MyViewHolder>{
    ...
    public AdapterMakanan(List <Barang> KategoriList) {
        this.mKategoriList = KategoriList;
    }

    @Override
    public AdapterMakanan.MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
    ...
    @Override
    public void onBindViewHolder (AdapterMakanan.MyViewHolder holder, final int position){
