...
public class CheckoutLuarSmenda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkout_luar_smenda);
...
//            String selectedImage = intent.getStringExtra("gambar");
            ...
            Glide.with(CheckoutLuarSmenda.this)
                ...
                if (json != "") {
                    ...
                    call.enqueue(new Callback<GetPesananModel>() {
                        ...
                        public void onResponse(Call<GetPesananModel> call, Response<GetPesananModel> response) {
                            dialog=new Dialog(CheckoutLuarSmenda.this);
                            ...
                            btnoke.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Intent intent1 = new Intent(CheckoutLuarSmenda.this, ArCode.class);
        ...
        public void Beli(View view) {
            ...
            progressBar = new ProgressDialog(CheckoutLuarSmenda.this);
            progressBar.show();
            ...
            if(TextUtils.isEmpty(tv3.getText().toString())){
                ...
                btnoke.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent1 = new Intent(CheckoutLuarSmenda.this, VerifikasiAkunAct.class);
