...
public class OTKPAct extends AppCompatActivity {
    TextView tvJudul;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otkpact);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
              if (s.length() > 0){
                  Call<GetJasaModel> kontakCall = mApiInterface.otkp(s);
                  kontakCall.enqueue(new Callback<GetJasaModel>() {
                      ...
                      public void onResponse(Call<GetJasaModel> call, Response<GetJasaModel>
                          ...
                          mAdapter = new AdapterOTKP(ListMenu);
    ...
    public void panggilRetrofit() {
        Call<GetJasaModel> kontakCall = mApiInterface.showotkp1();
        kontakCall.enqueue(new Callback<GetJasaModel>() {
            @Override
            public void onResponse(Call<GetJasaModel> call, Response<GetJasaModel>
                    response) {
