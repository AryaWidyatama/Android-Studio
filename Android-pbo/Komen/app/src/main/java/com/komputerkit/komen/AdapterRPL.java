...
public class AdapterRPL extends RecyclerView.Adapter<AdapterRPL.MyViewHolder>{

    List<JasaModel> mKategoriList;

    public AdapterRPL(List <JasaModel> KategoriList) {
        this.mKategoriList = KategoriList;
    }

    @Override
    public AdapterRPL.MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
    ...
    @Override
    public void onBindViewHolder (AdapterRPL.MyViewHolder holder, final int position){
