...
public class DaftarLuarSmenda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_luar_smenda);
        ...
        getDaftarCall.enqueue(new Callback<GetAkunAwal>() {
            ...
            public void onResponse(Call<GetAkunAwal> call, Response<GetAkunAwal> response) {
                if (response.isSuccessful()){
                    ...
                    Intent intent = new Intent(DaftarLuarSmenda.this,DaftarLanjutan.class);
                    intent.putExtra("NoTelp",etTelp.getText().toString());

                    intent.putExtra("Username",etUsernameBr.getText().toString());

                    intent.putExtra("Kelas","Luar");
                    intent.putExtra("Jurusan","Luar");
                    ...
                    dialog=new Dialog(DaftarLuarSmenda.this);
            ...
            public void onFailure(Call<GetAkunAwal> call, Throwable t) {
                ...
                Toast.makeText(DaftarLuarSmenda.this, message, Toast.LENGTH_LONG).show();
            }
        });
    }

    public void Masuk(View view) {
        Intent intent = new Intent(DaftarLuarSmenda.this, Login.class);
        startActivity(intent);
    }
}