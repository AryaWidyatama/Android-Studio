...
public class Ubahprofilguru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubahprofilguru);
...
//                }else {
//                    saveImageUpload();
                progressBar = new ProgressDialog(Ubahprofilguru.this);
                progressBar.show();
                progressBar.setContentView(R.layout.progres_dialog);
                progressBar.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
//                }
...
//        spinnerjurusan.setTag(loginModel.getJurusan());
        Glide.with(Ubahprofilguru.this)
                ...
                call.enqueue(new Callback<GetSiswa>() {
                    ...
                    public void onResponse(Call<GetSiswa> call, Response<GetSiswa> response) {
                        if (response.isSuccessful()) {
                            ...
                            Intent intent = new Intent(Ubahprofilguru.this, Login.class);
...
//                        PenjualActivity;
                    ...
                    public void onFailure(Call<GetSiswa> call, Throwable t) {
                        progressBar.dismiss();
                        Toast.makeText(Ubahprofilguru.this, "Harus ada data yang diubah!", Toast.LENGTH_SHORT).show();
                    }
                });
            }
    ...
    public void keluar(View view) {
        ...
        btnoke.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.clear();
                editor.commit();
                Intent intent = new Intent(Ubahprofilguru.this,Home.class);
