...
public class AdapterPBK extends RecyclerView.Adapter<AdapterPBK.MyViewHolder>{

    List<JasaModel> mKategoriList;

    public AdapterPBK(List <JasaModel> KategoriList) {
        this.mKategoriList = KategoriList;
    }

    @Override
    public AdapterPBK.MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
    ...
    @Override
    public void onBindViewHolder (AdapterPBK.MyViewHolder holder, final int position){
